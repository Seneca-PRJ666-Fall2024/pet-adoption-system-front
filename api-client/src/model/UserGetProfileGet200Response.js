...
import UserGetProfileGet200ResponseAllOfPayload from './UserGetProfileGet200ResponseAllOfPayload';
...
class UserGetProfileGet200Response {
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('payload')) {
                obj['payload'] = UserGetProfileGet200ResponseAllOfPayload.constructFromObject(data['payload']);
            }
        }
        return obj;
    }
    ...
    static validateJSON(data) {
        ...
        if (data['payload']) { // data not null
          UserGetProfileGet200ResponseAllOfPayload.validateJSON(data['payload']);
        }
...
/**
 * @member {module:model/UserGetProfileGet200ResponseAllOfPayload} payload
 */
